 ...
 * Se desea conocer cuantas paradas se van a realizar en el viaje y la longitud de los trayectos en kilometros.
 * Se desea conocer la longitud promedio entre ciudades y cuales son las paradas mas cercanas inicio 
 *   
 *   *------- * ---------------- * ----- * ----------- *  
 *       40             100          15        60
 */
...
public class Ejercicio998Ruta2 {
	public static void main(String[] args) {
		...
		for (int i = 0; i < distancias.length; i++) {
			...
			// km", "" + (i + 1));
			System.out.println("Ingrese la distancia de la ciudad " + (i + 1));
